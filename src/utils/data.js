...
export const heroData = [
    ...
    {id: 3 , name: 'Chicken Kebab', decp: "Mixed Kebad Plate", price: '8.25', imageSrc:C3},
    {id: 4 , name: 'Fixed Kebab', decp: "Mixed Fish Kebab", price: '5.25', imageSrc: Fi1},
]
...
export const categories = [
    ...
    {
        id: 3, name: 'Fish', urlParamName: 'fish', 
    }, 
    {
        id: 4, name: 'Rice', urlParamName: 'rice', 
    }, 
    {
